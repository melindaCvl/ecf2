<div class="row">
	<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 infos_public">
		ACTU
	...
	<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 infos_public">
		<form method="post" action="index.php">
			<fieldset>
				...
				<input type="text" class="form-control" id="identifiant" placeholder="Saisissez votre identifiant" name="identifiant">
				<br/>
				<input type="password" class="form-control" id="mot_de_passe" placeholder="Saisissez votre mot de passe" name="mot_de_passe">
				<br/>
